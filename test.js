...
// const text = "Name: jernja";
const simp_graph = lexical.simplifyGraph(regex);
const matched_dfa = lexical.findSubstrings(simp_graph, text);
...
for (const subs of matched_dfa[1]) {
  ...
  var tag_result = lexical.regexSubmatch(matched, M3_dict, M4_dict);
